...
fs.readFile('../../package.json', 'utf8', (err, data) => {
    ...
    try {
        ...
        if (!fs.existsSync(gitignore)) {
          ...
          console.log(`Le dossier "${gitignore}" a été créé avec succès.`);
        } else {
          console.log(`Le dossier "${gitignore}" existe déjà.`);
